...
import yatospace.user.session.control.DirectSessionController;
 ...
 * @version 1.0
 */
public class JavaSessionsTest {
	private static DirectSessionController sessionController = new DirectSessionController();
